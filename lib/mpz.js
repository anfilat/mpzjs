...
MPZ.prototype.inspect = function () {
...
MPZ.prototype.mod = function (value) {
    if (value instanceof MPZ) {
        return new MPZ(this._value.bmod(value._value));
    }
    const type = typeof value;
    if (type === 'number') {
        return new MPZ(this._value.umod(value));
    }
    if (type === 'string') {
        return new MPZ(this._value.bmod(new MPZ(value)._value));
    }
    throw new TypeError(`Unspecified mod for type ${type}`);
};

MPZ.mod = function (value1, value2) {
    if (value1 instanceof MPZ) {
        return value1.mod(value2);
    }
    return new MPZ(value1).mod(value2);
};

MPZ.prototype.and = function (value) {
    if (value instanceof MPZ) {
        return new MPZ(this._value.band(value._value));
    }
    return new MPZ(this._value.band(new MPZ(value)._value));
};

MPZ.and = function (value1, value2) {
    if (value1 instanceof MPZ) {
        return value1.and(value2);
    }
    return new MPZ(value1).and(value2);
};

MPZ.prototype.or = function (value) {
    if (value instanceof MPZ) {
        return new MPZ(this._value.bor(value._value));
    }
    return new MPZ(this._value.bor(new MPZ(value)._value));
};

MPZ.or = function (value1, value2) {
    if (value1 instanceof MPZ) {
        return value1.or(value2);
    }
    return new MPZ(value1).or(value2);
};

MPZ.prototype.xor = function (value) {
    if (value instanceof MPZ) {
        return new MPZ(this._value.bxor(value._value));
    }
    return new MPZ(this._value.bxor(new MPZ(value)._value));
};

MPZ.xor = function (value1, value2) {
    if (value1 instanceof MPZ) {
        return value1.xor(value2);
    }
    return new MPZ(value1).xor(value2);
};
...
MPZ.prototype.shiftLeft = function (num) {
    ...
    if (num >= 0) {
        return new MPZ(this._value.umul2exp(num));
    }
    return this.shiftRight(-num);
};

MPZ.shiftLeft = function (value, num) {
    if (value instanceof MPZ) {
        return value.shiftLeft(num);
    }
    return new MPZ(value).shiftLeft(num);
};
...
MPZ.prototype.shiftRight = function (num) {
    ...
    if (num >= 0) {
        return new MPZ(this._value.udiv2exp(num));
    }
    return this.shiftLeft(-num);
};

MPZ.shiftRight = function (value, num) {
    if (value instanceof MPZ) {
        return value.shiftRight(num);
    }
    return new MPZ(value).shiftRight(num);
};
